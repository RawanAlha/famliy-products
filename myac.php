                    ...
                    ?>
                            <div class="pdpt-bg">
                                <div class="pdpt-title flex justify-between">
                                    ...
                                    <h6>وقت التسليم: <?php echo $row['dv_time']; ?>, <?php echo $row['from']; ?> - <?php echo $row['tto']; ?></h6>
                                </div>
                                <div class="order-body10">
                                    ...
                                    <div class="track-order">
                                        ...
                                        <div class="bs-wizard" style="border-bottom: 0">
                                            ...
                                            <div class="bs-wizard-step complete">
                                                <div class="text-center bs-wizard-stepnum">معبأ</div>
                                                <div class="progress">
                                                    <div class="<?php
                                    ...
                                    ?>
                                        <div class="call-bill">
                                            <div class="order-bill-slip">
                                                <a href="dv_confirm.php?id=<?php echo $row['id'] ?>" class="bill-btn5 hover-btn">تأكيد</a>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
