                            ...
                            <div class="item">
                                <div class="productBox">
                                    ...
                                    <div class="product-detail">
                                        <p><?php
                                            if ($product['qty'] > 0) {
                                                echo "متوفر (في المخزن)";
                                            } else {
                                                echo "غير متوفر(نفذ المخزون)";
                                            } ?></p>
                                        ...
                                        <div class="price">ريال<?php echo $product['fa']; ?>
...
?>
    ...
    <section class="defaultPadding mt4">
        <div class="container mrlAuto">
            <div class="heading">
                <h2>الرجاء تحديد موقع لتصفح المنتجات</h2>
            </div>
        </div>
    </section>
<?php
