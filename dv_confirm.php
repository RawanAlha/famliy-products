    ...
    <section class="myac-body">
        <div class="flex row">
            <div class="right" style="flex-basis:100%">
                <h4><i class="uil uil-box"></i>طلباتي</h4>
                    ...
                    ?>
                            <div class="pdpt-bg">
                                <div class="pdpt-title flex justify-between">
                                    ...
                                    <h6> وقت التوصيل <?php echo $row['dv_time']; ?>, <?php echo $row['from']; ?> -
                                        <?php echo $row['tto']; ?></h6>
                                </div>
                                <div class="order-body10">
                                            ...
                                            <li>
                                                <div class="order-dt47">
                                                    ...
                                                    <div class="order-title">
                                                        كمية الطلب <?php echo $rw['qty']; ?> عنصر
                                                    </div>
                                                    <div class="order-title">
                                                        الكمية المسلمة <?php echo $rw['delivered_qty']; ?> عنصر
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="total-dt">
                                        ...
                                        <div class="main-total-cart">
                                            <h2>المجموع</h2>
                                            <span>ريال<?php echo $row['final_val']; ?></span>
                                        </div>
                                    </div>
                                    <div class="track-order">
                                        ...
                                        <div class="bs-wizard" style="border-bottom: 0">
                                            <div class="bs-wizard-step complete">
                                                <div class="text-center bs-wizard-stepnum">تم الطلب</div>
                                                <div class="progress">
                                                    <div class="<?php
                                        ...
                                        "></a>
                                            ...
                                            <div class="bs-wizard-step complete">
                                                <div class="text-center bs-wizard-stepnum">معبا</div>
                                                <div class="progress">
                                                    <div class="<?php
                                    ...
                                    ?>
                                        <div class="call-bill justify-between">
                                            <div class="order-bill-slip">
                                                <a href="javascript:void(0)" class="bill-btn5 hover-btn" onclick="confirm_delivered_order(<?php echo $oid ?>)">تأكيد</a>
                                            </div>
                                            <div class="order-bill-slip" style="margin-left:1rem">
                                                <a href="javascript:void(0)" class="bill-btn5 hover-btn" onclick="not_confirm_delivered_order(<?php echo $oid ?>)">لم يتم التأكيد</a>
                                            </div>
                                        </div>
                                    <?php } ?>
                                </div>
