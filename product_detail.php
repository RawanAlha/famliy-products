                ...
                <div class="right">
                    ...
                    <div class="no-stock">
                        ...
                        <p class="stock-qty">
                            <?php
                            if ($product['qty'] > 0) {
                                echo "متوفر<span>(في المخزن)</span>";
                            } else {
                                echo "غير متوفر<span>(نفذ من المخزن)</span>";
                            } ?></p>
                    </div>
                    <p class="pp-descp">
                        ...
                        <ul>
                            <li>
                                <div class="main-price color-discount">
                                    سعر الخصم<span> ريال <?php echo $product['fa']; ?></span>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                ?>
                                            <button class="order-btn hover-btn" onclick="go_to_cart()">
                                                <i class="uil uil-shopping-cart-alt"></i> اذهب إلى العربة
                                            </button>
                                        <?php
                                        } else {
                                        ?>
                                            <button class="order-btn hover-btn" onclick="addToCart(<?php echo $product['id']; ?>,this)">
                                                <i class="uil uil-shopping-cart-alt"></i> أضف إلى العربة
                                            </button>
                                        <?php
                                        }
                                    } else {
                                    ...
                                    ?>
                                        <button class="order-btn hover-btn" onclick="addToCart(<?php echo $product['id']; ?>,this)">
                                            <i class="uil uil-shopping-cart-alt"></i>  اضف إلى العربة
                                        </button>
                                <?php
                                    }
                                }
                        ...
                        <ul class="flex">
                            <li>
                                <div class="pdp-group-dt">
                                    ...
                                    <div class="pdp-text-dt">
                                        <span> أقل سعر مضمون</span>
                                        <p>
                                            احصل على استرداد الفرق إذا وجدت أنه أرخص في أي مكان آخر
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="pdp-group-dt">
                                    ...
                                    <div class="pdp-text-dt">
                                        <span>إرجاع واسترداد الأموال بسهولة</span>
                                        <p>
                                           قم بإرجاع المنتجات إلى باب منزلك واحصل على استرداد الأموال خلال ثوانٍ
                                        </p>
                                    </div>
                                </div>
                            </li>
                                            ...
                                            <div class="detail">
                                                ...
                                                <div class="qty-group">
                                                    <div class="cart-item-price">
                                                        ريال<?php echo $row['fa']; ?>
                                                        <span> ريال <?php echo $row['price']; ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
