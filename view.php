                    ...
                    <div class="shop-by-depertment" style="margin-top:2rem;">
                        ...
                        <ul>
                            ...
                            <div class="inrow" style="margin-top: 1.5rem;">
                                ...
                                <div class="in">
                                    <h4>ريال<span id="fnlp">1000</span></h4>
                                </div>
                                <div class="in">
                                    <h4 class="underline" onclick="filterPrice()" style="cursor:pointer">تصفية</h4>
                                </div>
                            </div>
                        </ul>
                        ...
                        ?>
                                <div class="product" style="background:#fff">
                                    ...
                                    <div class="detail">
                                        ...
                                        <p class="price">ريال<span class="ftrp"><?php echo $product['fa'] ?></span></p>
                                    </div>
                                </div>
                        <?php
                            }
                        } else {
                            echo "<h1>لا يوجد شيء</h1>";
                        }
