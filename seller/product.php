...
<div class="cartrow" id="catrow">
    <div class="gh">
        <div class="heading">
            <h3>جميع المنتجات</h3>
            <a href="add_product.php?b=1973">إضافة منتج</a>
        </div>
            ...
            <table class="wishlist">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        $idd = $row['id'];
                        if ($row['isappp'] == 0) {
                            $st = "<span class='badge ofd'>قيد الانتظار</span>";
                        } else if ($row['isappp'] == 2) {
                            $st = "<span class='badge red'>مرفوض</span>";
                        } else if ($row['status'] == 1) {
                            $st = "<span class='badge green'>نشط</span>";
                            $cb = '<a href="javascript:void(0)" class="nedit" onclick="product_acdc(' . $idd . ', 0)">
                            <i class="uil uil-wifi-slash"></i>
                        </a>';
                        } else {
                            $st = "<span class='badge ofd'>غير نشط</span>";
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)">
                                    <img src="../media/product/<?php echo $row['img1']; ?>" alt="المنتج" />
                                </a>
                            </td>
