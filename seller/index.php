...
<span class="fs-14">إجمالي المشاريع المنجزة</span>
...
<span class="fs-14">جهات الاتصال التي لديك</span>
...
<span class="fs-14">إجمالي المهام الغير منتهية</span>
...
<span class="fs-14">الرسائل غير المقروءة</span>
        ...
        <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6" style="flex-basis:100%;">
            <div class="card card-bd">
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                           <span class="fs-14" style="text-transform: capitalize;">تم إنشاء ملفك الشخصي ولكن لم يتم
إكماله. يرجى إكمال ملف تعريفك للمتابعة</span>
<br>
<br>
<a href="complete_profile.php?hash=<?php echo hash_code() ?>" class="btn-a-a-a">إكمال
الملف الشخصي</a>
</div>
                        <svg class="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.9999 1.5H5.99994C3.51466 1.5 1.49994 3.51472 1.49994 6V29.8125C1.49994 32.2977 3.51466 34.3125 5.99994 34.3125H11.9999C14.4852 34.3125 16.4999 32.2977 16.4999 29.8125V6C16.4999 3.51472 14.4852 1.5 11.9999 1.5Z" fill="#20F174"></path>
        ...
        <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6" style="flex-basis:100%;">
            <div class="card card-bd">
                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        <div class="media-body mr-3">
                           <span class="fs-14" style="text-transform: capitalize;">تم إكمال ملف التعريف الخاص بك ولكن لم يتم التحقق منه من قبل المسؤول. يرجى الانتظار للتحقق</span>
<br>
<br>
</div>
                        <svg class="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span class="fs-14" style="text-transform: capitalize;">تم رفض ملفك الشخصي من قبل

المسؤول.</span>

<br>

<span class="fs-14" style="text-transform: capitalize;">ملاحظات:
