...
<div class="wrwr">
    <div class="path" id="path">
        ...
        <span>/</span>
        <a href="sellerapprove.html">قبول البائعين</a><span>/</span>
        <a href="view_seller_approve.html">عرض</a>
    </div>
    <div class="headrow">
        <div class="wrap" style="height: 30rem;">
            ...
            <div class="detail" style="float: right">
                <h4>رقم الـ GST: <span style="color:#6a7187;"><?php echo $row['gst_id']; ?></span></h4>
    ...
    <textarea name="" id="rejection" style="width:99%;resize:none;padding:1.5rem;outline:none;" rows="8" placeholder="في حالة الرفض، يرجى تحديد السبب"></textarea>
    <div class="row_a">
