    ...
    <div class="rowbtn">
        <div class="b" style="display:flex;flex-direction:column;padding:3rem 2rem">
            <div class="mask" style="display:flex;flex-direction:row;align-items:center">
                <h1 style="color:#40464d">من:&nbsp;&nbsp; </h1>
                <input type="date" placeholder="أدخل نوع العمل" id="sfield1" style="width:98.5%;margin:1rem 0;" />
            </div>
            <div class="mask" style="display:flex;flex-direction:row;align-items:center">
                <h1 style="color:#40464d">إلى:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h1>
                <input type="date" placeholder="أدخل نوع العمل" id="sfield2" style="width:98.5%;margin:1rem 0;" />
            </div>
            <div class="mask" style="display:flex;flex-direction:row;align-items:end">
                <button class="add" onclick="earning_search()" id="btn">بحث</button>
            </div>
