                                                            ...
                                                            <div class="order-dt47">
                                                                <h4>تم التسليم
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <?php
                                                                        if ($rw['rcvd'] == 1) {
                                                                            echo "&nbsp; تم التأكيد <i class='fa fa-check-square' aria-hidden='true' style='color:#0066ff'></i>";
                                                                        } else {
                                                                            echo "&nbsp; غير مؤكد";
                                                                        }
                                                                    } else {
...
<div class="call-bill">
    ...
    ?>
        <div class="delivery-man">
            ...
            <select name="" id="dvselect" style="border:1px solid #cecbcb;">
                <option value="#">اختر صبي التوصيل</option>
                <?php
        ...
        <div class="order-bill-slip">
            <a href="javascript:void()0" onclick="assign(<?php echo $oid; ?>)" class="bill-btn5 hover-btn">تعيين</a>
        </div>
    <?php } else {
    ...
    class="bill-btn5 hover-btn">إعادة التعيين</a>
    <a href="javascript:void()0" onclick="reassign_finalize(' . $oid . ')"
    class="bill-btn5 hover-btn">الانتهاء</a>
</div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
        } else {
