...
<div class="path">
  <div class="container">
    ...
    /
    <a href="index.html">قائمة المفظلة</a>
  </div>
</div>
<section class="wishlist">
  ...
  <section class="myac-body">
    <div class="flex row">
      ...
      <div class="right">
        <h4><i class="uil uil-heart"></i>قائمة المفظلة </h4>
            ...
            ?>
                <div class="wish-item">
                  ...
                  <div class="cart-text">
                    ...
                    <div class="cart-item-price"> ريال <?php echo $row['fa']; ?> <span> ريال <?php echo $row['price']; ?></span></div>
